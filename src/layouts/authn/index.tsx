  ...
  return (
    <>
      <main className="relative flex h-screen flex-col items-center gap-8 pb-12 lg:h-screen lg:w-screen lg:flex-row lg:justify-between lg:gap-0 lg:p-0">
        <div className="-order-1 h-16 w-full bg-[url('/src/pages/auth/SignIn/ui/geometric-shapes-mobile.svg')] bg-center lg:order-1 lg:aspect-[4/5] lg:h-screen lg:w-auto lg:bg-[url('/src/pages/auth/SignIn/ui/geometric-shapes-desktop.svg')] lg:bg-cover" />
